 ...
 * @author Mert
 */
public class Gezgin_Zeplin extends javax.swing.JFrame {

   
    public Gezgin_Zeplin() {
        initComponents();
    }
    ...
    {
        Logger.getLogger(Gezgin_Zeplin.class.getName()).log(Level.SEVERE, null, ex);
    }
   ...
   sonuclar[i-5]=sonuc.toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Gezgin_Zeplin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
